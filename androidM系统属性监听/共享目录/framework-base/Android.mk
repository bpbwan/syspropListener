...
## READ ME: ########################################################
LOCAL_SRC_FILES += \
        media/java/android/media/IAudioLogicListener.aidl \
        media/java/android/media/IClickSoundListener.aidl \
        media/java/android/media/IScreenTouchListener.aidl \
	core/java/android/app/IActivityFocusListener.aidl \
